...
"""
# Comment by Maali Tars: modified the original file https://github.com/macsnoeren/python-p2p-network after what was shown in seminar 8 and my own additions
...
class NodeConnection(threading.Thread):
    ...
    def __init__(self, main_node, sock, id, host, port):
        ...
        self.main_node.debug_print("NodeConnection.send: Started with client (" + str(self.id) + ") '" + self.host + ":" + str(self.port) + "'")
